      ...
      <form id="wasteForm">
        ...
        <div class="form-group">
          ...
          <div class="custom-select-container" id="kecSelectContainer">
            <div class="custom-select-wrapper">
              <input type="text" id="kecamatanSelect" class="form-select form-input-lg" placeholder="Ketik/Pilih Kecamatan..." autocomplete="off" value="${userDesa ? userDesa.kecamatan : ''}" style="border: 1px solid var(--border-color);" ${isKader ? 'disabled' : ''} />
        ...
        <div class="form-group" id="desaGroup" style="display:${userDesa ? 'block' : 'none'}">
          ...
          <div class="custom-select-container" id="desaSelectContainer">
            <div class="custom-select-wrapper">
              <input type="text" id="desaSelectInput" class="form-select form-input-lg" placeholder="Ketik/Pilih Desa..." autocomplete="off" value="${userDesa ? userDesa.desa_kelurahan : ''}" style="border: 1px solid var(--border-color);" ${isKader ? 'disabled' : ''} />
              ${isKader ? '' : '<span class="custom-select-arrow">▼</span>'}
            </div>
