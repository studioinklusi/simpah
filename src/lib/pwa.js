...
export function getNavbarInstallButton(className = 'nav-link') {
  ...
  return `
    <button type="button" id="navbarInstallBtn" data-pwa-install class="${className}" style="display:inline-flex;align-items:center;background:none;border:none;padding:0;font:inherit;cursor:pointer;color:inherit">
