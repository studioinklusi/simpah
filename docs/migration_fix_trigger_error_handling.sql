-- Migration: Fix handle_new_user() trigger with detailed error handling
-- This update wraps the INSERT in an exception block so that
-- the actual database error (e.g. FK violation, unique constraint)
-- is surfaced in the error message instead of generic "Database error saving new user"
