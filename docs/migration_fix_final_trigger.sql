-- Final Migration: Fix handle_new_user() trigger with proper search_path and email syncing
-- Run this script in the Supabase SQL Editor to resolve the registration error.
...
BEGIN
  ...
  BEGIN
    INSERT INTO public.profiles (id, username, full_name, role, job_type, location_id, desa_id, kecamatan, email)
    VALUES (
      new.id,
      v_username,
